...
<body>
    ...
    <div class="btn-group">
        <button class="btn btn-personalizado" onclick="location.href='?c=insEmpleado';">Insertar Empleado</button>
        <button class="btn btn-personalizado" onclick="location.href='?c=insControlEmpl';">Insertar en Control</button>
